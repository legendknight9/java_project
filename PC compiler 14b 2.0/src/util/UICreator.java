...
public class UICreator {
	...
	public static JPanel createSelectPICUI(String deviceList[]) {
		...
		panel.add(panel_2);
		panel_2.setLayout(new RelativeLayout(RelativeLayout.X_AXIS, 30));
	...
	public static JPanel createConfigUI(final String processor,
			String configFileName) {
		String data[] = FileHandler.readFile(new File(constants.DFSP
				+ configFileName), -1);
		int line = 0;
	...
	public static JPanel createAddFileRow(String filePath) {
		JPanel row = new JPanel(new RelativeLayout(RelativeLayout.X_AXIS, 10));
		JLabel lblFiles = new JLabel(filePath);
		row.add(lblFiles, new Float(8));
