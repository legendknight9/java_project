...
public class memory {
	...
	public memory() {
		ram = new RAM();
		PMP1 = new String[2048];
		PMP2 = new String[2048];
		PMP3 = new String[2048];
		PMP4 = new String[2048];		
	}
	...
	class RAM {
		...
		public RAM() {
			...
			statusTable = new Hashtable<Integer, Integer>(constants.RAMSIZE);
			setRAMAddress();
		}
		...
		public int getAvailableAddress() {
		    for (int index = 0; index < constants.RAMSIZE; index++) {
