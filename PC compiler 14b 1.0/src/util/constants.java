...
public class constants {
	...
	// PIC
	public static final int RAMSIZE = 368;
	public static final int EEROMSIZE = 256;
	public static final int PMSIZE = 8192;
	public static final int NULL = -1;
	
	// Config UI
	public static final String CONFIGUI_TITLE = "Select option for project";
	public static final String CONFIGUI_SELECTBT = "Set";
	public static final String OPTIONFILEPATH = "/PC compiler 14b/src/input/configoption";
